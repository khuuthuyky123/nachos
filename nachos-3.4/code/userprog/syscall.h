...
/* Hàm đọc số nguyên do người dùng nhập vào*/
int ReadInt();

/* Hàm xuất số nguyên ra màn hình */
void PrintInt(int number);

/* Hàm đọc ký tự do người dùng nhập vào*/
char ReadChar();

/* Hàm xuất ký tự ra màn hình */
void PrintChar(char character);

/* Hàm đọc chuỗi do người dùng nhập vào*/
